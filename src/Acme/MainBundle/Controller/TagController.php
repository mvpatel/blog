...
use Acme\MainBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeMainBundle:Tag')->findAll();

        return $this->render('AcmeMainBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function tagAction($tagId)
    {
        ...
        $entities = $em->getRepository('AcmeMainBundle:Tag')->findById($tagId);
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AcmeMainBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeMainBundle:Tag')->find($id);
        ...
        return $this->render('AcmeMainBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeMainBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
